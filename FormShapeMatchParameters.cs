...
namespace EmguCVDemoJmalino
{
    ...
    public partial class FormShapeMatchParameters : Form
    {
        ...
        public delegate void DelegateApplyShapeMatching(Image<Bgr, byte> imgTemplate, double threshold = 0.0001, double area = 1000, ContoursMatchType matchType = ContoursMatchType.I2);
        ...
        public FormShapeMatchParameters()
        {
            ...
            //int margin for a small buffer in starting position from absolute corner
            int margin = 20;
            //sets starting position to right side of the primary screen, in the working area width - set margin
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // TryParse will try this MinArea and if there is any exception it will default to this areaThreshold
                double.TryParse(tbMinArea.Text, out areaThreshold);

                double threshold = 0.0001;
                // TryParse will try this DistanceThreshold and if there is any exception it will default to this threshold
